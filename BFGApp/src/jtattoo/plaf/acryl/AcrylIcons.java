...
import jtattoo.plaf.*;
import jtattoo.plaf.acryl.icons.ImageHelper;
...
//------------------------------------------------------------------------------
    private static class TitleButtonIcon implements Icon {
        ...
        public void paintIcon(Component c, Graphics g, int x, int y) {
            ...
            if (!isActive) {
                ...
                cShadow = AbstractLookAndFeel.getTheme().getControlShadow();
                cFrame = AbstractLookAndFeel.getTheme().getWindowInactiveBorderColor();
                cFrameInner = ColorHelper.brighter(cFrameInner, 80);
            }
    ...
    private static class CheckBoxIcon implements Icon {
        ...
        private static Icon checkInactiveIcon = jtattoo.plaf.icons.ImageHelper.loadImage("CheckSymbol.gif");
        ...
        public void paintIcon(Component c, Graphics g, int x, int y) {
            ...
            if (!b.isEnabled()) {
            ...
            } else if (b.isRolloverEnabled() && model.isRollover() && !model.isArmed()) {
                ...
                if (JTattooUtilities.isFrameActive(b)) {
                    ...
                    JTattooUtilities.fillHorGradient(g, AbstractLookAndFeel.getTheme().getInActiveColors(), x + 1, y + 1, WIDTH - 2, HEIGHT - 2);
                    frameColor = ColorHelper.brighter(frameColor, 40);
                }
            }
            ...
            if (model.isPressed() && model.isArmed()) {
                ...
                if ((gv > 128) || !model.isEnabled() || !JTattooUtilities.isFrameActive(b)) {
    ...
    private static class RadioButtonIcon implements Icon {
        ...
        public void paintIcon(Component c, Graphics g, int x, int y) {
            ...
            if (!b.isEnabled()) {
                ...
                if (JTattooUtilities.isFrameActive(b)) {
                    JTattooUtilities.fillHorGradient(g, AbstractLookAndFeel.getTheme().getDefaultColors(), x, y, WIDTH, HEIGHT);
                } else {
                    JTattooUtilities.fillHorGradient(g, AbstractLookAndFeel.getTheme().getInActiveColors(), x, y, WIDTH, HEIGHT);
                    frameColor = ColorHelper.brighter(frameColor, 40);
                }
            }
