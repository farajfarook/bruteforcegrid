...
public class About extends JDialog {
    ...
    public static String JTATTOO_VERSION = "Version: 1.3.1";
    private static Dimension screenSize = Toolkit.getDefaultToolkit().getScreenSize();
    private static Dimension dlgSize = new Dimension(320, 240);
    ...
    public About() {
        ...
        JLabel copyrightLabel = new JLabel("(C) 2002-2009 by MH Software-Entwicklung");
